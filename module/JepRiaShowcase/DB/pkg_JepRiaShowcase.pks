...
/* const: New_FeatureStatusCode
  Код статуса запроса на функционал "Новый".
*/
New_FeatureStatusCode   constant varchar2(10) := 'NEW';

/* const: Sequenced_FeatureStatusCode
  Код статуса запроса на функционал "Установлен порядок выполнения".
*/
Sequenced_FeatureStatusCode   constant varchar2(10) := 'SEQUENCED';
