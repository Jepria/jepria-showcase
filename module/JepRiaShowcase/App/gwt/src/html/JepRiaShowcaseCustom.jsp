...
<html style="width: 100%; height: 100%;">
  ...
  <body style="margin: 0px; padding: 0px; width: 100%; height: 100%; min-width: 812px; min-height: 640px;">
        ...
        <td colspan="3" style="height: 20%; padding: 5px;">
          <table style="width: 100%; height: 100%;">
            ...
            <tr>
              ...
              <td style="height: 100%; text-align: right;">
                <div id="<%= JepRiaShowcaseCustomPageElements.BOTTOM_ELEMENT %>" style="width: 100%; height: 100%; position: relative; text-align: left;"></div>
              </td>
            </tr>
          </table>
        </td>
